...
class Root:
    ...
    def SegmentButon(self):
        ...
        self.segmentbt =customtkinter.CTkSegmentedButton(master=self.root,
                                                        ...
                                                        text_color=("blue","white"),command=self.Segment_BT)
        self.segmentbt.place(x=200,y =0)     
        
    def Segment_BT(self,value) :
    ...
    def HomeFrame(self):
        ...
        self.time_label = customtkinter.CTkLabel(master=self.ProfileFrame,text="hello")
        self.time_label.place(x=90,y=50)
